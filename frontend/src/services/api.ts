...
// `Scan` is also imported locally below — some types still defined in this
// file (e.g. DashboardStats.recent_scans) reference it.  The barrel line
// above re-exports the whole scans domain for consumers.
