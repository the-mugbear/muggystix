...
// Locally-needed symbols from sibling modules — some types STILL defined in
// this file reference them (FollowStatus/NoteStatus/NoteType on the host
// types below).  The barrel lines above re-export these domains for
// consumers; these imports just bind the names for in-file use.
import type { FollowStatus, NoteStatus, NoteType } from './api/shared';
