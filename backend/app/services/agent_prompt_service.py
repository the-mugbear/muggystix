...
def build_assist_instructions(
    *,
    ...
    instructions = (
        ...
        f"(hosts, criticals, highs, unassigned) sorted worst-first — the "
        f"answer to \"where should we look?\" without running a count per "
        f"subnet and comparing them yourself.\n"
