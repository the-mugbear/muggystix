...
> **Status:** Unimplemented planning document. No live CVE API integration exists — CVE data currently comes from Nessus/OpenVAS scan imports only. Still accurate as of backend 2.201.0 (2026-06-13): no live CVE feed has been wired in.
